; BOARD #1: AKILLI IKLIMLENDIRME VE HABERLESME SISTEMI 
...
INITIALIZE:
    BANKSEL TRISA
    MOVLW   B'00000001'         ; RA0 Analog Giris
    MOVWF   TRISA
    CLRF    TRISD               ; PORTD Cikis
    MOVLW   B'11110001'         ; RB0: Interrupt, RB1-3: Sutun, RB4-7: Satir
    MOVWF   TRISB
...
;--- ANA DONGU ---
MAIN_LOOP:
    CALL    ADC_READ            ; Sensor oku
    CALL    HVAC_SYSTEM         ; Karar mekanizmasi
    CALL    UART_CONTROL        ; Board #2 ile haberlesme
    CALL    DISPLAY_ROTATION    ; 2sn'lik ekran gecisleri
...
KEY_SCAN:
    ...
    MOVLW   B'01111111'
    MOVWF   PORTB
    BTFSS   PORTB, 1            ; * Tusu (Ondalik)
    GOTO    SET_FRAC
    BTFSS   PORTB, 2            ; 0 Tusu
    MOVLW   .0
    CALL    PROCESS_KEY
    BTFSS   PORTB, 3            ; # Tusu (Onay)
    GOTO    VERIFY_EXIT
    GOTO    KEY_SCAN
...
VERIFY_EXIT:
    ...
    SUBWF   TEMP_INT, W
    BTFSS   STATUS, C
    GOTO    ISR_FINISH          ; Hatali: 10'dan kucuk
    
    MOVLW   .51
    SUBWF   TEMP_INT, W
    BTFSC   STATUS, C
    GOTO    ISR_FINISH          ; Hatali: 50'den buyuk
